      ...
      <div className="col col-l">
        <div className="ro">
          ...
          <div className="col">
            <div className="row">
              <img
                src="https://images.unsplash.com/photo-1559563458-527698bf5295?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                alt=""
              />
              <button>
                <Link to="/products/1" className="link">
